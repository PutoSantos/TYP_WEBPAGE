...
<body>
	...
	<div class="container-fluid text-center">  
			<div class="col-sm-12 text-center conteudo"> 
				...
				<form action="HRecoverPassword" method="post">
					<div class="container">
						<label>Introduza o email da conta que pretende criar uma nova password</label><br><br><br>
						<label>E-mail</label>
						<input class="input" type="email" style="width:450px;color:black;" placeholder="exemplo@exeemplo.com" name="email" required><br>
						<button type="submit" style="width:300px;">Recuperar Password</button>
					</div>
				</form>
				<%
					boolean valida = (boolean) request.getAttribute("validaEmail");
							
					if(valida != true)
					{
						out.append("O Email introduzido nao se encontra na base de dados");
					}
					else
					{
						out.append("Email encontrado");
					}			
				%>
			</div>
